...
class CloudWatchLogsAgentSetup:
    ...
    def install_awslogs_cli(self):
        ...
        if self.is_standalone:
            ...
            self.do_pip_install('awscli-cwlogs==1.4.3', True, plugin_path, True)
        else:
            ...
            if self.plugin_url:
                ...
                self.do_pip_install('awscli-cwlogs==1.4.3', True, None, True, self.plugin_url)
            else:
                if need_wheel_29:
                    self.do_pip_install('wheel==0.29.0', True, None, True)
                self.do_pip_install('awscli-cwlogs==1.4.3', True, None, True)
